    ...
    <div class=".sc-AxmLO gmtmqV">
        <div class="sc-fzoXWK fRnHrz">
                        ...
                        <div class="likes-dislikes flex-row">
                            <p class="flex-row like">
                                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"
                                    fill="#AAAAAA" width="22" height="22">
                                    <g>
                                        <path
                            ...
                            <p class="flex-row dislike" style="margin-left: 1rem">
                                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" width="22"
                                    height="22">
                                    <g>
                                        <path
                ...
                <div class="sc-fzoyTs fNzLaQ">
                    ...
                    <div class="add-comment">
                        <img src="https://res.cloudinary.com/douy56nkf/image/upload/v1594060920/defaults/txxeacnh3vanuhsemfc8.png"
                            alt="avatar" /><textarea placeholder="Add a public comment"></textarea>
                    </div>
                    <div class="comment">
                        <a href="/channel/1311e080-5e0e-4b4b-bb83-08f1a6837649"><img
                                src="https://res.cloudinary.com/douy56nkf/image/upload/v1594060920/defaults/txxeacnh3vanuhsemfc8.png"
                                alt="avatar" /></a>
                        <div class="comment-info">
                            <p class="secondary">
                                <span><a href="/channel/1311e080-5e0e-4b4b-bb83-08f1a6837649">akshaydsvg</a></span><span
                                    style="margin-left: 0.6rem">11 hours ago</span>
                            </p>
                            <p>vnd</p>
                        </div>
                    </div>
            ...
            <div class="related-videos">
                ...
                </a><a href="/watch/05f411f6-9c9d-4e97-8d65-47847cd99e87">
                    <div class="sc-fzozJi dteCCc">
                        <img class="thumb"
                ...
                </a><a href="/watch/b4bafa92-b60d-40a8-ad50-ecd47406edd5">
                    <div class="sc-fzozJi dteCCc">
                        <img class="thumb"
